...
def sub_disassociate_GroupWise(disList):
	...
	while loop:
		...
		if choice == '1':
			...
			disList.buildList('directory', ['user', 'group','resource'], userInput)
			print ("URLs have been added to the disassociate list")
			logger.info("URLs have been added to the disassociate list")
			gw.eContinue()
		elif choice == '3':
			...
			disList.buildList('dom', ['user', 'group','resource'], userInput)
			print ("URLs have been added to the disassociate list")
			logger.info("URLs have been added to the disassociate list")
			gw.eContinue()
		elif choice == '4':
			...
			disList.buildList('post', ['user', 'group','resource'], userInput)
			print ("URLs have been added to the disassociate list")
			logger.info("URLs have been added to the disassociate list")
			gw.eContinue()
		elif choice == '5':
			...
			disList.buildList('name', ['user', 'group','resource'], userInput)
			print ("URLs have been added to the disassociate list")
			logger.info("URLs have been added to the disassociate list")
			gw.eContinue()
		elif choice == '0':
...
def sub_disassociate_select(disList, disType):
	...
	while loop:
		...
		if choice == '1':
			...
			gw.gwappBanner()
			userInput = raw_input("LDAP Directory ID: ")
			disList.buildList('directory', [selectType[disType]], userInput)
			print ("URLs have been added to the disassociate list")
			logger.info("URLs have been added to the disassociate list")
			gw.eContinue()
		elif choice == '3':
			gw.gwappBanner()
			userInput = raw_input("Domain: ")
			disList.buildList('dom', [selectType[disType]], userInput)
			print ("URLs have been added to the disassociate list")
			logger.info("URLs have been added to the disassociate list")
			gw.eContinue()
		elif choice == '4':
			gw.gwappBanner()
			userInput = raw_input("Post Office: ")
			disList.buildList('post', [selectType[disType]], userInput)
			print ("URLs have been added to the disassociate list")
			logger.info("URLs have been added to the disassociate list")
			gw.eContinue()
		elif choice == '5':
			gw.gwappBanner()
			userInput = raw_input("Object Name: ")
			disList.buildList('name', [selectType[disType]], userInput)
			print ("URLs have been added to the disassociate list")
			logger.info("URLs have been added to the disassociate list")
			gw.eContinue()
		elif choice == '0':
